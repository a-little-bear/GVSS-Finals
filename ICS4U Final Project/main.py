...
def get_lessons_screen_sprites() -> list[Button]:
    ...
    """
    for i in range(1, 9):
        lessons_screen_sprites_texts.append(setting.get("lesson_"+str(i)))
                ...
                match(event.key):
                    case pg.K_ESCAPE:
                        ...
                        #go back to the previous window
                            ...
                            setting.set("switch_window", True)
                ...
                match(windows.top()):
                    ...
                    case _:
                        ...
                        for i in range(1, 9):
                            ...
                            if windows.top() == setting.get("lesson_"+str(i)).lower():
                                valid = True
            ...
            case "setting":
                ...
                if setting["switch_window"]:
                    match(setting["next_window"]):
                        case "main_screen":
                            windows.pop()
                            setting.set("next_window", windows.top())
                    ...
                    match(setting["next_window"]):
                        ...
                        case _:
                            ...
                            for i in range(1, 9):
                                ...
                                if setting["next_window"] == setting.get("lesson_"+str(i)).lower():
                                    switched = True
                        ...
                        if setting["switch_window"]:
                            ...
                            match(setting["next_window"]):
                                case "lessons":
                                    ...
                                    sprites.add(lessons_screen_sprites)
                                    setting.set("play_vid", False)
                                    setting.set("pause", False)
